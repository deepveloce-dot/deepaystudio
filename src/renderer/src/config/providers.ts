...
export const PROVIDER_URLS: Record<SystemProviderId, ProviderUrls> = {
  ...
  ppio: {
    ...
    websites: {
      official: 'https://ppio.com/user/register?invited_by=JYT9GD&utm_source=github_modaui-studio&redirect=/',
      apiKey:
        'https://ppio.com/user/register?invited_by=JYT9GD&utm_source=github_modaui-studio&redirect=/settings/key-management',
      docs: 'https://docs.cherry-ai.com/pre-basic/providers/ppio?invited_by=JYT9GD&utm_source=github_modaui-studio',
      models: 'https://ppio.com/model-api/product/llm-api?invited_by=JYT9GD&utm_source=github_modaui-studio'
    }
  },
  gemini: {
    api: {
  ...
  alayanew: {
    ...
    websites: {
      official: 'https://www.alayanew.com/backend/register?id=modauistudio',
      apiKey: ' https://www.alayanew.com/backend/register?id=modauistudio',
      docs: 'https://docs.alayanew.com/docs/modelService/interview?utm_source=modauistudio',
      models: 'https://www.alayanew.com/product/deepseek?id=modauistudio'
    }
  },
  openrouter: {
    api: {
