...
describe('api', () => {
  ...
  describe('routeToEndpoint', () => {
    ...
    it('extract OpenAI images generations endpoint', () => {
      expect(routeToEndpoint('https://open.modauiin.net/v1/images/generations#')).toEqual({
    ...
    it('extract Gemini images generation endpoint', () => {
      expect(routeToEndpoint('https://open.modauiin.net/v1beta/models/imagen-4.0-generate-001:predict#')).toEqual({
        baseURL: 'https://open.modauiin.net/v1beta/models/imagen-4.0-generate-001',
        endpoint: 'predict'
      })
    })
  })
