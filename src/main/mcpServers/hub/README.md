...
A built-in MCP server that aggregates all active MCP servers in Modaui Studio and exposes them through **meta-tools**.

This server is the core component of Modaui Studio’s **Auto MCP Mode**.
