...
Rules:
- These are your primary interface to ModauiStudio's autonomous features. Do not attempt workarounds or alternative approaches.
...
/**
 * PromptBuilder assembles the system prompt for ModauiStudio agents.
 *
 * Two entry points:
 *
