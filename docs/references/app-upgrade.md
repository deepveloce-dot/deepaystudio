...
1. Open the Modaui Studio repository on GitHub → **Actions** tab → select **Update App Upgrade Config**.
...
- **GitCode**: `https://gitcode.com/CherryHQ/modaui-studio/raw/x-files/app-upgrade-config/app-upgrade-config.json`
    ...
    "1.6.7": {
      ...
      "channels": {
        "latest": {
          "version": "1.6.7",
          "feedUrls": {
            "github": "https://github.com/CherryHQ/modaui-studio/releases/download/v1.6.7",
            "gitcode": "https://gitcode.com/CherryHQ/modaui-studio/releases/download/v1.6.7"
          }
        },
        "rc": {
          "version": "1.6.0-rc.5",
          "feedUrls": {
            "github": "https://github.com/CherryHQ/modaui-studio/releases/download/v1.6.0-rc.5",
            "gitcode": "https://github.com/CherryHQ/modaui-studio/releases/download/v1.6.0-rc.5"
          }
        },
        "beta": {
          "version": "1.6.7-beta.3",
          "feedUrls": {
            "github": "https://github.com/CherryHQ/modaui-studio/releases/download/v1.7.0-beta.3",
            "gitcode": "https://github.com/CherryHQ/modaui-studio/releases/download/v1.7.0-beta.3"
          }
        }
      }
    },
  ...
  "2.8.0": {
    ...
    "channels": {
      "latest": {
        "version": "2.8.0",
        "feedUrls": {
          "github": "https://github.com/CherryHQ/modaui-studio/releases/download/v2.8.0",
          "gitcode": "https://gitcode.com/CherryHQ/modaui-studio/releases/download/v2.8.0"
        }
      },
      "rc": null,
      "beta": null
  ...
  "3.0.0": {
    ...
    "channels": {
      "latest": {
        "version": "3.0.0",
        "feedUrls": {
          "github": "https://github.com/CherryHQ/modaui-studio/releases/latest",
          "gitcode": "https://gitcode.com/CherryHQ/modaui-studio/releases/latest"
        }
      },
      "rc": {
        "version": "3.0.0-rc.1",
        "feedUrls": {
          "github": "https://github.com/CherryHQ/modaui-studio/releases/download/v3.0.0-rc.1",
          "gitcode": "https://gitcode.com/CherryHQ/modaui-studio/releases/download/v3.0.0-rc.1"
        }
      },
      "beta": null
    }
