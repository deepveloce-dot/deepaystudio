...
## Modaui Studio workflow (READ FIRST — overrides packaging / install steps below)

You are running inside Modaui Studio. Skills live in a managed global registry,
