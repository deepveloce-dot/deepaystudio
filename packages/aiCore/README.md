...
Modaui Studio AI Core 是一个基于 Vercel AI SDK 的统一 AI Provider 接口包，为 AI 应用提供强大的抽象层和插件化架构。
...
```bash
npm install @modauistudio/ai-core ai @ai-sdk/google @ai-sdk/openai
```
...
```typescript
import { AiCore } from '@modauistudio/ai-core'
...
```typescript
import { createOpenAIExecutor } from '@modauistudio/ai-core'
...
```typescript
import { registerProvider, AiCore } from '@modauistudio/ai-core'
...
```typescript
import { webSearchPlugin } from '@modauistudio/ai-core/built-in/plugins'
...
```typescript
import { createLoggingPlugin } from '@modauistudio/ai-core/built-in/plugins'
...
```typescript
import { createPromptToolUsePlugin } from '@modauistudio/ai-core/built-in/plugins'
...
```typescript
import { definePlugin } from '@modauistudio/ai-core'
...
```typescript
import { createClient } from '@modauistudio/ai-core'
...
更强大的是，你还可以将自定义注册表与 Modaui Studio 的插件系统结合使用：

```typescript
import { PluginEnabledAiClient } from '@modauistudio/ai-core'
import { createProviderRegistry } from 'ai'
import { createOpenAI } from '@ai-sdk/openai'
import { anthropic } from '@ai-sdk/anthropic'
...
- [Modaui Studio 项目](https://github.com/CherryHQ/modaui-studio)
...
MIT License - 详见 [LICENSE](https://github.com/CherryHQ/modaui-studio/blob/main/LICENSE) 文件

---

**Modaui Studio AI Core** - 让 AI 开发更简单、更强大、更灵活 🚀
