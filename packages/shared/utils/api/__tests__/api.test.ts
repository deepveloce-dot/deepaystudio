...
describe('api', () => {
  ...
  describe('isWithTrailingSharp', () => {
    ...
    it('handles complex real-world URLs', () => {
      expect(isWithTrailingSharp('https://open.modauiin.net/v1/chat/completions#')).toBe(true)
      ...
      expect(isWithTrailingSharp('https://open.modauiin.net/v1/chat/completions')).toBe(false)
